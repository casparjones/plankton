...
1. **Niemals** `/vibe/readme.md` überschreiben oder löschen
...
8. Der Manager prüft `/vibe/ideas/` **vor** jeder neuen Task-Erstellung
9. Tester prüft **immer** ob `cargo build` ohne Fehler durchläuft
10. Kein Agent löscht Dateien – nur verschieben in `/vibe/done/`
---
